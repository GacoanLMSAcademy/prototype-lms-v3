...
const routes = [
  ...
  // ── Admin (super admin — all CRUD) ──
  {
    ...
    children: [
      ...
      { path: 'technical-test', name: 'admin-technical-test', component: () => import('@/views/admin/TechnicalTestList.vue') },
      { path: 'technical-test/new', name: 'admin-technical-test-new', component: () => import('@/views/admin/TechnicalTestForm.vue') },
      { path: 'technical-test/:id', name: 'admin-technical-test-edit', component: () => import('@/views/admin/TechnicalTestForm.vue') },
