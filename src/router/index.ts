...
const routes = [
  ...
  // ── Admin (super admin — all CRUD) ──
  {
    ...
    children: [
      ...
      { path: 'category-training-method', name: 'admin-category-training-method', component: () => import('@/views/admin/CategoryTrainingMethodList.vue') },
      { path: 'category-training-method/new', name: 'admin-category-training-method-new', component: () => import('@/views/admin/CategoryTrainingMethodForm.vue') },
      { path: 'category-training-method/:id', name: 'admin-category-training-method-edit', component: () => import('@/views/admin/CategoryTrainingMethodForm.vue') },
      { path: 'program-category', name: 'admin-program-category', component: () => import('@/views/admin/ProgramCategoryList.vue') },
      { path: 'program-category/new', name: 'admin-program-category-new', component: () => import('@/views/admin/ProgramCategoryForm.vue') },
      { path: 'program-category/:id', name: 'admin-program-category-edit', component: () => import('@/views/admin/ProgramCategoryForm.vue') },
      { path: 'program-type', name: 'admin-program-type', component: () => import('@/views/admin/ProgramTypeList.vue') },
      { path: 'program-type/new', name: 'admin-program-type-new', component: () => import('@/views/admin/ProgramTypeForm.vue') },
      { path: 'program-type/:id', name: 'admin-program-type-edit', component: () => import('@/views/admin/ProgramTypeForm.vue') },
      { path: 'training-method', name: 'admin-training-method', component: () => import('@/views/admin/TrainingMethodList.vue') },
      { path: 'training-method/new', name: 'admin-training-method-new', component: () => import('@/views/admin/TrainingMethodForm.vue') },
      { path: 'training-method/:id', name: 'admin-training-method-edit', component: () => import('@/views/admin/TrainingMethodForm.vue') },
